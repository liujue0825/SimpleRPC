...
import com.lj.rpc.core.serialization.SerializationFactory;
...
public class SharableRpcMessageCodec extends MessageToMessageCodec<ByteBuf, RpcMessage> {
    ...
    protected void encode(ChannelHandlerContext ctx, RpcMessage rpcMessage, List<Object> list) throws Exception {
        ...
        Serialization serialization = SerializationFactory.getSerialization(SerializerType.parseType(header.getSerializerType()));
