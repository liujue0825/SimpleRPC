...
/**
 * 自定义的 RPC 服务端的后置处理器，实现将自定义的注解扫描{@link com.lj.rpc.server.annotation.RpcService}，并进行服务注册并缓存
 *
 * @author liujue
 */
@Slf4j
public class RpcServerBeanPostProcessor implements BeanPostProcessor, CommandLineRunner {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean.getClass().isAnnotationPresent(RpcService.class)) {
            ...
            String serviceName = ServiceUtil.getServiceName(interfaceName, version);
